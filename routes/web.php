...
Route::middleware(['auth'])->group(function() {
    ...
    Route::get('/order', [OrderController::class, 'index_orders'])->name('index_orders');
    Route::get('/order/{order}', [OrderController::class, 'show_order'])->name('show_order');
    Route::post('/order/{order}/pay', [OrderController::class, 'submit_payment_receipt'])->name('submit_payment_receipt');
    Route::get('/profile', [ProfilController::class, 'show_profile'])->name('show_profile');
    Route::post('/profile', [ProfilController::class, 'edit_profile'])->name('edit_profile');
});
